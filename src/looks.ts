...
Image #2 is the locked template photo. The final image must look like the SAME photograph as #2: same camera, same crop, same distance, same angle, same background, same lighting, same shadows, same garment silhouette, same hang/flat-lay/studio presentation, same wrinkles, same fabric drape, same collar/sleeves/hem. If #2 is a black studio shot, keep that black studio. If #2 is a white flat lay, keep that white flat lay. Do not invent a different scene, set, or mockup style.
